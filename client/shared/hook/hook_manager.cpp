...
void gtamp::hook::hook_manager::set_exe_memory(void *exe_memory)
{
	gtamp::hook::hook_manager::exe_memory = exe_memory;
}

void *gtamp::hook::hook_manager::get_exe_memory()
{
	return gtamp::hook::hook_manager::exe_memory;
}

std::vector<gtamp::hook::section> gtamp::hook::hook_manager::get_sections()
{
	...
	dos_header = (PIMAGE_DOS_HEADER)(gtamp::hook::hook_manager::exe_memory);
	...
	// Get the NT Headers
	nt_headers = (PIMAGE_NT_HEADERS)(&((char *)gtamp::hook::hook_manager::exe_memory)[dos_header->e_lfanew]);
